...
WebUI.click(findTestObject('Object Repository/Page_Eklipse/div_X'))

WebUI.click(findTestObject('Object Repository/Page_Eklipse/button_Skip for now'))

WebUI.click(findTestObject('Object Repository/Page_Eklipse/a_AI EditNew'))

WebUI.click(findTestObject('Object Repository/Page_Eklipse/button_Start AI Edit'))

WebUI.click(findTestObject('Object Repository/Page_Eklipse/button_Start AI Edit'))

WebUI.click(findTestObject('Object Repository/Page_Eklipse/div_Local Upload'))

WebUI.click(findTestObject('Object Repository/Page_Eklipse/label_Upload a Video'))
